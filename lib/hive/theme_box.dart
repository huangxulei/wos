...
bool get displayHighRate =>
    themeBox.get(displayHighRateKey, defaultValue: false);
//显示模式 id号/高度/宽度/刷新频率
DisplayMode get displayMode {
  ...
  final double refreshRate =
      themeBox.get(displayModeRefreshRateKey, defaultValue: 0.0);
  return DisplayMode(
      id: id, height: height, width: width, refreshRate: refreshRate);
}
...
int get iconColor =>
    themeBox.get(iconColorKey, defaultValue: tomatoCat[iconColorKey]);
...
int get cardBackgroundColor => themeBox.get(cardBackgroundColorKey,
    defaultValue: tomatoCat[cardBackgroundColorKey]);
